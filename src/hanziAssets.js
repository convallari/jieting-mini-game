...
const glyphOverrides = {
  ...
  "黄": { role: "char", fontScale: 0.58, baseline: 0.17, tilt: 0.015, paper: "#f9f5d8", ink: "#8a641c" },
  "忠": { role: "char", fontScale: 0.58, baseline: 0.18, tilt: -0.015, paper: "#f9f5d8", ink: "#17120f" },
