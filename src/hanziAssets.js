...
const glyphOverrides = {
  ...
  "马": { role: "char", fontScale: 0.66, baseline: 0.18, tilt: 0.015, paper: "#f9f5d8", ink: "#8a641c" },
  "超": { role: "char", fontScale: 0.58, baseline: 0.18, tilt: -0.015, paper: "#f9f5d8", ink: "#17120f" },
  "谡": { role: "char", fontScale: 0.594, baseline: 0.18, tilt: -0.018, paper: "#f5edcf", ink: "#17120f" },
  "王": { role: "char", fontScale: 0.748, baseline: 0.17, tilt: 0.01, paper: "#edf4df", ink: "#173127" },
  "平": { role: "char", fontScale: 0.715, baseline: 0.17, tilt: -0.008, paper: "#edf4df", ink: "#173127" },
